  ...
  return (
    <div className="p-3 md:mx-auto ">
      ...
      <div className="flex-wrap flex gap-4 py-3 mx-auto justify-center">
        <div className="flex flex-col w-full md:w-auto shadow-md p-2 rounded-md dark:text-gray-800">
          <div className="flex justify-between p-3 text-md dark:text-white font-semibold">
            <h1 className="text-center p-2 ">Recent users</h1>
            <Button outline gradientDuoTone={"purpleToPink"} type="button">
